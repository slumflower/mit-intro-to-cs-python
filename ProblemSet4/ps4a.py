    ...
    while calculateHandlen(hand) != 0:
        ...
        if user_word == ".":
            ...
            if isValidWord(user_word, hand, wordList) == False:
                ...
                total_score += getWordScore(user_word, n)
                print('"' + str(user_word) + '"', "earned", str(getWordScore(user_word, n)), "points. Total: ", str(total_score), "points")
...
def playGame(wordList):
    ...
    while True:
        ...
        if user_input == 'r':
            ...
            #if hand has not been played yet
            except:
            ...
            #call to dealhand and playHand function
